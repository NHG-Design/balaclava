...
Experimental `query()`/`form()`/`command()`/`prerender()` in `.remote.ts` files — patterns, validation, devalue serialization, single-flight updates, and gotchas. Verified against SvelteKit 2.58.0, 2026-04-24.
