 ...
 *
 * Each run of reference/critique.md writes a per-target snapshot to
 *   .interface/critique/<timestamp>__<slug>.md
 * with a small YAML frontmatter carrying the score + P0/P1 counts.
 *
 * reference/polish.md reads the latest matching snapshot at start as its
...
import { getCritiqueDir } from './interface-paths.mjs';
