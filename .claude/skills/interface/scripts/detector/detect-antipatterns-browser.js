/**
 * Anti-Pattern Browser Detector for Interface
...
function checkElementQualityDOM(el) {
  ...
  const rect = el.getBoundingClientRect();
  const lineMax = (typeof window !== 'undefined' && window.__INTERFACE_CONFIG__?.lineLengthMax) || 80;
