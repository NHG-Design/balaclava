...
**WARNING - AI SLOP TRAP**: Review ALL the DON'T guidelines from the interface skill (already loaded in this context) before proceeding. Bold means distinctive, not "more effects."
...
When the result feels right, run a final polish pass (load `reference/polish.md`).
