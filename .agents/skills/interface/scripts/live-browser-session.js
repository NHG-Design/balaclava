/**
 * Browser-side durable session helpers for interface live mode.
 *
 ...
 * window.__INTERFACE_LIVE_SESSION__.
 */
(function (root) {
  'use strict';
  ...
  root.__INTERFACE_LIVE_SESSION__ = { createLiveBrowserSessionState };
