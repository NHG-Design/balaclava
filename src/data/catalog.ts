...
export const CATALOG: Readonly<Record<ResourceId, Resource>> = {
    ...
    [RESOURCE.DIAMOND_RING]:      { id: RESOURCE.DIAMOND_RING,      name: 'Diamond Ring',       kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 50_000,  tornId: 54    },
    [RESOURCE.ELEPHANT_STATUE]:   { id: RESOURCE.ELEPHANT_STATUE,   name: 'Elephant Statue',    kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 25_000,  tornId: 280   },
    ...
    [RESOURCE.GLITTER_BOMB]:      { id: RESOURCE.GLITTER_BOMB,      name: 'Glitter Bomb',       kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 10_000,  tornId: 1294  },
    [RESOURCE.GOLD_TOOTH]:        { id: RESOURCE.GOLD_TOOTH,        name: 'Gold Tooth',         kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 15_000,  tornId: 1282  },
    [RESOURCE.GRENADE]:           { id: RESOURCE.GRENADE,           name: 'Grenade',            kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 10_000,  tornId: 220   },
    [RESOURCE.HARD_DRIVE]:        { id: RESOURCE.HARD_DRIVE,        name: 'Hard Drive',         kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 3_000,   tornId: 45    },
    [RESOURCE.JADE_BUDDHA]:       { id: RESOURCE.JADE_BUDDHA,       name: 'Jade Buddha',        kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 30_000,  tornId: 275   },
    [RESOURCE.KABUKI_MASK]:       { id: RESOURCE.KABUKI_MASK,       name: 'Kabuki Mask',        kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 20_000,  tornId: 278   },
    ...
    [RESOURCE.MAYAN_STATUE]:      { id: RESOURCE.MAYAN_STATUE,      name: 'Mayan Statue',       kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 20_000,  tornId: 259   },
    [RESOURCE.OPIUM]:             { id: RESOURCE.OPIUM,             name: 'Opium',              kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 100_000, tornId: 200   },
    [RESOURCE.PCP]:               { id: RESOURCE.PCP,               name: 'PCP',                kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 2_000,   tornId: 201   },
    [RESOURCE.PELE_CHARM]:        { id: RESOURCE.PELE_CHARM,        name: 'Pele Charm',         kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 50_000,  tornId: 265   },
    [RESOURCE.RAW_IVORY]:         { id: RESOURCE.RAW_IVORY,         name: 'Raw Ivory',          kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 80_000,  tornId: 358   },
    [RESOURCE.STAPLER]:           { id: RESOURCE.STAPLER,           name: 'Stapler',            kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 1_000,   tornId: 1286  },
    [RESOURCE.STICK_GRENADE]:     { id: RESOURCE.STICK_GRENADE,     name: 'Stick Grenade',      kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 5_000,   tornId: 221   },
    [RESOURCE.SUMO_DOLL]:         { id: RESOURCE.SUMO_DOLL,         name: 'Sumo Doll',          kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 30_000,  tornId: 427   },
    [RESOURCE.SYRINGE]:           { id: RESOURCE.SYRINGE,           name: 'Syringe',            kind: 'evidence', category: 'misc',     isTool: false, defaultPrice: 5_000,   tornId: 1094  },
